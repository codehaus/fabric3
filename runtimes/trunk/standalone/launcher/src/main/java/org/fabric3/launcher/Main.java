...
public class Main {
    ...
    public static void main(String[] args) throws Throwable {
        ...
        if (!applicationFile.exists()) {
            System.err.println(getMessage("org.fabric3.launcher.NoComposite", applicationFile));
            System.exit(2);
        }
        ...
        if (applicationScdlURL == null) {
            System.err.println(getMessage("org.fabric3.launcher.NoApplicationSCDL", applicationScdl));
            System.exit(2);
        }
    ...
    private static void usage() {
        System.err.println(getMessage("org.fabric3.launcher.Usage"));
        System.exit(1);
    }
