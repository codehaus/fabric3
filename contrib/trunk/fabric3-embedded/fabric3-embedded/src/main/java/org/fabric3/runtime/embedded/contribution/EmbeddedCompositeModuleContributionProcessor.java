...
@EagerInit
public class EmbeddedCompositeModuleContributionProcessor implements ContributionProcessor {

    private ProcessorRegistry registry;
    private ContentTypeResolver contentTypeResolver;
    private Loader loader;

    public EmbeddedCompositeModuleContributionProcessor(@Reference ProcessorRegistry registry,
