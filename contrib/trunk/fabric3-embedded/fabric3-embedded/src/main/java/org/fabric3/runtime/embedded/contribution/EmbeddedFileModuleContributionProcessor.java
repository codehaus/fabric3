...
@EagerInit
public class EmbeddedFileModuleContributionProcessor implements ContributionProcessor {

    private ProcessorRegistry registry;
    private ContentTypeResolver contentTypeResolver;
    private Loader loader;

    public EmbeddedFileModuleContributionProcessor(@Reference ProcessorRegistry registry,
    ...
    public void processManifest(Contribution contribution, final IntrospectionContext context) throws InstallException {
        ...
        try {
            ...
            URL manifestUrl = new URL(sourceUrl.toExternalForm() + "/sca-contribution.xml");
