...
public class EmbeddedMonitorEventDispatcherFactory implements MonitorEventDispatcherFactory {
    private EmbeddedMonitorEventDispatcher dispatcher;

    public EmbeddedMonitorEventDispatcherFactory() {
        dispatcher = new EmbeddedMonitorEventDispatcher();
    }
