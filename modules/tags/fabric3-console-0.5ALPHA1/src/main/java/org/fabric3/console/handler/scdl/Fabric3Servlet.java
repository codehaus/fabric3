...
/**
 * Super class for all the Fabric3 servlets.
 * 
...
@EagerInit
public abstract class Fabric3Servlet extends HttpServlet {
     ...
     */
    public Fabric3Servlet(ServletHost servletHost, String path) {
