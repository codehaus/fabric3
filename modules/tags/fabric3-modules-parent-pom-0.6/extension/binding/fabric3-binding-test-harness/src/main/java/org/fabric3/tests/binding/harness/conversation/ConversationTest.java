...
public class ConversationTest extends TestCase {
    ...
    public void testConversationalInvoke() throws Exception {
        conversationalService.setData("test");
        assertEquals("test", conversationalService.getData());
        conversationalService.clear();
        assertNull(conversationalService.getData());
        conversationalService.setData("test2");
        assertEquals("test2", conversationalService.getData());
    }
}
