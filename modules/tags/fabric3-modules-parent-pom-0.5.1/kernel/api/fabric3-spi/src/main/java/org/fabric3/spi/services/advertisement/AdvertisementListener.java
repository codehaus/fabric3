...
/**
 * Listener for receiving notification on feature registration and removal.
 *
...
public interface AdvertisementListener {
     ...
     */
    void featureAdded(QName feature);

    /**
     * Callback when a feature is removed.
     * @param feature Removed feature.
     */
    void featureRemoved(QName feature);
