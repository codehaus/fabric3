...
/**
 * Verifies {@link org.fabric3.runtime.webapp.Fabric3SessionListener} notifies the runtime of session events
 *
 * @version $Rev$ $Date$
 */
public class Fabric3SessionListenerTestCase extends TestCase {
    ...
    public void testSessionPropagated() throws Exception {
        ...
        Fabric3SessionListener listener = new Fabric3SessionListener();
