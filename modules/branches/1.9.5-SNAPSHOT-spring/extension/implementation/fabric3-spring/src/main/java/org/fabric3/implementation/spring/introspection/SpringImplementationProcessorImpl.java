...
public class SpringImplementationProcessorImpl implements SpringImplementationProcessor {
    ...
    private static final String SCA_NS_F3 = Constants.SCA_NS +"/f3";
    private static final QName SERVICE_F3 = new QName(SCA_NS_F3, "service");
    private static final QName REFERENCE_F3 = new QName(SCA_NS_F3, "reference");
    private static final QName PROPERTY_F3  = new QName(SCA_NS_F3, "property");
    private static final QName PRODUCER_F3  = new QName(SCA_NS_F3, "producer");
    private static final QName CONSUMER_F3  = new QName(SCA_NS_F3, "consumer");
        ...
        try {
            ...
            while (true) {
                ...
                case START_ELEMENT:
                    ...
                    } else if (SERVICE.equals(reader.getName()) || SERVICE_F3.equals(reader.getName()) ) {
                        if (!processService(type, reader, context)) {
                            return type;
                        }
                    } else if (REFERENCE.equals(reader.getName()) || REFERENCE_F3.equals(reader.getName()) ) {
                        if (!processReference(type, reader, context)) {
                            return type;
                        }
                    } else if (PROPERTY.equals(reader.getName()) || PROPERTY_F3.equals(reader.getName()) ) {
                        if (!processProperty(type, reader, context)) {
                            return type;
                        }
                    } else if (PRODUCER.equals(reader.getName()) || PRODUCER_F3.equals(reader.getName()) ) {
                        if (!processProducer(type, reader, context)) {
                            return type;
                        }
                    } else if (CONSUMER.equals(reader.getName()) || CONSUMER_F3.equals(reader.getName()) ) {
