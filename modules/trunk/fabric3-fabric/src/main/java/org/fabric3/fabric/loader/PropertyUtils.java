...
public final class PropertyUtils {
    ...
    public static Document createPropertyValue(XMLStreamReader reader, QName type, DocumentBuilder builder)
        ...
        Document doc = createPropertyDocument(type, builder);

        loadPropertyValue(reader, doc.getDocumentElement());
        return doc;
    }

    public static Document createPropertyValue(String value, QName type, DocumentBuilder builder) {
        Document doc = createPropertyDocument(type, builder);
    ...
    public static Document createPropertyDocument(QName type, DocumentBuilder builder) {
