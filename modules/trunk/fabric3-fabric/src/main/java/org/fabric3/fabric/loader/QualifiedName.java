...
public class QualifiedName {
     ...
     * composite.
     *
     * @param qualifiedName the string to parse
     ...
     *
     * @return the parsed port name if the original is of the compound for part/port
     */
     ...
     *
     * @return the full part/port name pair
     */
