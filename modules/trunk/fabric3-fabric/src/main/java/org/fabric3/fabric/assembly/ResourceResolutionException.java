 ...
 * @version $Rev$ $Date$
 */
public abstract class ResourceResolutionException extends AssemblyException {
    public ResourceResolutionException(String message, String identifier) {
        super(message, identifier);
    }

    public ResourceResolutionException(String message, String identifier, Throwable cause) {
