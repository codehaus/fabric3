...
public class StartCompositeContextGeneratorTestCase extends TestCase {
    ...
    protected void setUp() throws Exception {
        ...
        component = new LogicalComponent<CompositeImplementation>(PARENT, runtimeUri, parentDefinition);
        LogicalComponent<?> child = new LogicalComponent<CompositeImplementation>(CHILD, runtimeUri, childDefinition);
