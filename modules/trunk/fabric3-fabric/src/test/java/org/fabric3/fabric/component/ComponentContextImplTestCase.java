...
public class ComponentContextImplTestCase extends TestCase {
    private ComponentContextProvider component;
    ...
    public void testGetProperty() throws ObjectCreationException {
        String name = "foo";
        String value = "bar";
    ...
    public void testGetPropertyThatIsIncompatible() throws ObjectCreationException {
        String name = "foo";
    ...
    public void testGetPropertyThatIsSubclass() throws ObjectCreationException {
        String name = "foo";
        String value = "bar";
    ...
    public void testGetService() throws ObjectCreationException {
        String name = "foo";
    ...
    protected void setUp() throws Exception {
        super.setUp();
        component = EasyMock.createMock(ComponentContextProvider.class);
