 ...
 */
public class JmsMessageDestinationService implements MessageDestinationService {

    /** Queue on which the consumer is listening. */
    private String queueName;

    /**
     * @param queueName Injects the queue name.
     */
    @Property
