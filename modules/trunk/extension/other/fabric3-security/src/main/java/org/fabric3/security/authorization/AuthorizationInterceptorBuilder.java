...
/**
 * Builder for the authorization interceptor. The builde is injected with the authorization service extension.
 * <p/>
 * TODO We may need to support multiple authorization services based on the context in which the authorization service is used. The reference to
