...
/**
 * Converts from a DOM Node to a JAXB type. Note the JAXBContext is not cached as there is no reliable way to create a unique key. This transformer
 * should not be in a runtime invocation path as creating JAXBContext instances is expensive.
 *
 * @version $Rev$ $Date$
 */
public class Node2JaxbTransformer extends AbstractPullTransformer<Node, Object> implements ComplexTypePullTransformer<Node, Object> {
