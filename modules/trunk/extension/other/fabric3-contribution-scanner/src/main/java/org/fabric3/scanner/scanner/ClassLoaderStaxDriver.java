 ...
 * implementation.
 * <p/>
 * TODO JFM: Duplicate of the same class in fabric module - extracting the class into a third module results in a cyclic
 * dependency that needs to be refactored
 *
 * @version $Rev$ $Date$
 */
