...
public class SCAParentApplicationContext implements ApplicationContext {
    ...
    private SpringComponentDefinition componentDefinition;

    private static final String[] EMPTY_ARRAY = new String[0];
    
    private SpringComponent<?> springComponent = null;

    public SCAParentApplicationContext(ClassLoader classLoader,
                                       SpringComponentDefinition componentDefinition) {
    ...
    public Object getBean(String name, Class requiredType) throws BeansException {
        ...
        Map<String, ReferenceDefinition> references = componentDefinition.getReferences();
        if (references.keySet().contains(name)) {
              ReferenceDefinition referenceDefinition = references.get(name);
              try {
                  return springComponent.getObjFactory(name).getInstance();
        ...
        return null;
//        for (Reference reference : componentDefinition.getReferences()) {
