...
/**
 * Interface for deploying/activating processed definition objects.
 * 
 * @version $Revision$ $Date$
 */
public interface DefinitionsDeployer {
    
    /**
     * Activates the definition.
     * 
     * @param definitionName Qualified name of the definition.
