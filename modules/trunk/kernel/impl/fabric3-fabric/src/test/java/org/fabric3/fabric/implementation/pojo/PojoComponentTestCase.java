...
public class PojoComponentTestCase<T> extends TestCase {
    ...
    public void testLifecycleAndWrapperCreation() throws ObjectCreationException {
        ...
        expect(instanceFactory.newInstance(workContext)).andReturn(wrapper);
        replay(provider, instanceFactory, wrapper, scopeContainer);
        component.createInstanceWrapper(workContext);
        verify(provider, instanceFactory, wrapper, scopeContainer);
...
*/
    ...
    public static class TestComponent<T> extends PojoComponent<T> {
        ...
        public TestComponent(URI componentId,
                             ...
                             long maxAge,
                             String key) {
            super(componentId, instanceFactoryProvider, scopeContainer, null, initLevel, maxIdleTime, maxAge, Collections.EMPTY_MAP);
        }
    }
}
