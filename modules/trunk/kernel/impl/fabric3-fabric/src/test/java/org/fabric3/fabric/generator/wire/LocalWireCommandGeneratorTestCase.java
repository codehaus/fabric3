...
public class LocalWireCommandGeneratorTestCase extends TestCase {
    ...
    public void testTargetCollectDetachMultiplicity1ToNReference() throws Exception {
        ...
        EasyMock.expect(wireGenerator.generateUnboundWire(source, reference, service, target)).andReturn(wireDefinition);
        EasyMock.expect(wireGenerator.generateUnboundWire(source, reference, service2, target2)).andReturn(wireDefinition);
