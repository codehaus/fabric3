...
public class LogicalModelGeneratorImpl implements LogicalModelGenerator {
    ...
    private List<LogicalReference> instantiateReferences(LogicalComponent<CompositeImplementation> parent,
            Composite composite, String base) {
    ...
    private List<LogicalService> instantiateServices(LogicalComponent<CompositeImplementation> parent,
            Composite composite, String base) {
