...
import org.fabric3.system.introspection.SystemComponentTypeLoader;
import org.fabric3.system.introspection.SystemComponentTypeLoaderImpl;
...
public class BootstrapLoaderFactory {
    ...
    public static Loader createLoader(MonitorFactory monitorFactory,
        ...
        FeatureLoader featureLoader = new FeatureLoader(loader, introspector, loaderHelper);
        featureLoader.start();
