...
/**
 * Responsible for dispatching to a callback service from a composite scoped component implementation instance.
 *
 * @version $Rev$ $Date$
 */
public class CompositeScopeCallbackInvocationHandler<T> implements InvocationHandler {
     ...
     */
    public CompositeScopeCallbackInvocationHandler(Class<T> interfaze, boolean conversational, Map<String, Map<Method, InvocationChain>> mappings) {
