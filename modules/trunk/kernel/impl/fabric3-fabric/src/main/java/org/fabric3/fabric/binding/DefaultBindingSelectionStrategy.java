...
/**
 * Implements a binding selection strategy by choosing the first available provider.
 *
 * @version $Revision$ $Date$
 */
public class DefaultBindingSelectionStrategy implements BindingSelectionStrategy {
