...
/**
 * Loads extension dependency entries in a contribution manifest.
 *
 * @version $Rev$ $Date$
 */
@EagerInit
public class MavenExtensionImportLoader implements TypeLoader<MavenImport> {
    ...
    public MavenImport load(XMLStreamReader reader, IntrospectionContext context) throws XMLStreamException {
        ...
        MavenExtensionImport imprt = new MavenExtensionImport();
