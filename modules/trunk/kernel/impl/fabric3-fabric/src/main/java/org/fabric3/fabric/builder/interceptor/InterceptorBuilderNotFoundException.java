...
public class InterceptorBuilderNotFoundException extends BuilderException {
    ...
    /**
     * @param clazz Interceptor definition class.
     */
    public InterceptorBuilderNotFoundException(Class<? extends PhysicalInterceptorDefinition> clazz) {
        super("Interceptor builder not found", clazz.getName());
    }
}
