 ...
 * @version $Rev$ $Date$
 */
public class String2QNameTransformer extends AbstractPullTransformer<String, QName> {
    ...
    public QName transform(String source, TransformContext context) throws TransformationException {
