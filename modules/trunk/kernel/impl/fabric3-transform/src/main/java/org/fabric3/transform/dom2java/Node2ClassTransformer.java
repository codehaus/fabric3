 ...
 * @version $Rev$ $Date$
 */
public class Node2ClassTransformer implements SingleTypeTransformer<Node, Class<?>> {
    ...
    public Node2ClassTransformer(@Reference ClassLoaderRegistry classLoaderRegistry) {
