 ...
 * @version $Rev$ $Date$
 */
public class Node2FloatTransformer extends AbstractSingleTypeTransformer<Node, Float> {
    ...
    public Float transform(Node node, ClassLoader loader) throws TransformationException {
        try {
