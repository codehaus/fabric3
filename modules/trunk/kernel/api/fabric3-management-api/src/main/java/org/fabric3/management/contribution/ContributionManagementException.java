...
public class ContributionManagementException extends Exception {
    ...
    public ContributionManagementException(String message) {
        super(message);
    }

    public ContributionManagementException(String message, Throwable cause) {
        super(message, cause);
    }

    public ContributionManagementException(Throwable cause) {
        super(cause);
    }
}
