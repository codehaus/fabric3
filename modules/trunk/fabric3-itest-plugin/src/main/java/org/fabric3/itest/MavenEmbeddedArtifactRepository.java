 ...
 * @version $Rev$ $Date$
 */
public class MavenEmbeddedArtifactRepository implements org.fabric3.spi.services.artifact.ArtifactRepository {
    ...
    public void resolve(org.fabric3.spi.services.artifact.Artifact artifact) {
     ...
     */
    public boolean resolveTransitively(org.fabric3.spi.services.artifact.Artifact rootArtifact) {
     ...
     */
    private boolean resolveDependencies(org.fabric3.spi.services.artifact.Artifact rootArtifact,
                                        Artifact mavenRootArtifact) {
        ...
        try {
            ...
            for (Object obj : result.getArtifacts()) {
                ...
                org.fabric3.spi.services.artifact.Artifact artifact =
                    new org.fabric3.spi.services.artifact.Artifact();
